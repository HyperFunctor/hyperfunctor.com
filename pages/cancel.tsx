      ...
      <div className="max-w-screen-sm container mx-auto">
        ...
        <div className="rounded bg-white shadow p-8">
          <div className="text-center text-2xl font-semibold">
            {website.status.title}: <span className="text-orange-500">{website.status.cancel.title}</span>
          </div>
          <p className="mt-4 prose text-center text-gray-800">{website.status.cancel.blob}</p>
        </div>
      </div>
    </section>
  );
