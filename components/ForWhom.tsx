...
export const ForWhom = () => {
  return (
    <section className="relative py-16 bg-gradient-to-r from-pink-50 to-gray-50 border-t-4 border-pink-400" id="forwhom">
