      ...
      <div className="container mx-auto px-8">
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-2/3">
            ...
            ></h1>
            <h2
              className="text-3xl text-gray-500 leading-tight"
            ...
            <div className="mt-10">
              <a
                href="#buy-course"
                className="inline-block w-full text-center md:w-auto bg-gray-800 text-gray-100 active:bg-gray-100 text-lg font-bold uppercase px-6 py-3 rounded shadow hover:shadow-md outline-none focus:outline-none lg:mr-1 lg:mb-0"
              >
                {joinButton}
              </a>
            </div>
