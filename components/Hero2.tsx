            ...
            <div>
              ...
              <div className="mt-6 sm:max-w-xl">
                <h1 className="text-5xl font-extrabold text-gray-900 tracking-tight">
                  Zacznij programować <br/> <span className="text-pink-400">juz dziś</span>
                </h1>
              ...
              <div className="mt-6">
                <div className="min-w-0 flex-1 py-1 text-gray-500 sm:py-3">
                  <span className="font-medium text-gray-900">Kurs zaczyna się</span>{' '}
                  <span className="font-medium text-pink-600">18 stycznia 2022</span>
                </div>
              </div>
            </div>
          </div>
