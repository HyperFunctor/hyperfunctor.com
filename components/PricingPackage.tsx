  ...
  return (
    <div className="overflow-hidden mt-12 lg:mt-0 shadow-md max-w-2xl">
      {isOn ? (
        ...
        <div className="bg-gray-50 border-t p-10 flex flex-col items-center">
          <p className="font-bold text-4xl text-center leading-snug">
            Kurs Next.js, Reacta i TypeScripta „Zaiste, Programuj!” powróci!
          </p>
          <p className="font-normal text-xl text-center leading-snug mt-4 -mb-6">
            Zapisz się na Newsletter, aby dostać maila, gdy kurs ponownie będzie
            w sprzedaży.
          </p>
          <Newsletter />
        </div>
