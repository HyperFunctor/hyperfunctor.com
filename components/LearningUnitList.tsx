  ...
  return (
    <section className="pb-20 bg-gray-100 py-16">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <p className="text-lg leading-relaxed font-light mb-8" dangerouslySetInnerHTML={{ __html: data.unit.paragraph_1 }}></p>
        <p className="text-lg leading-relaxed font-light mb-8" dangerouslySetInnerHTML={{ __html: data.unit.paragraph_2 }}></p>
        <p className="text-lg leading-relaxed font-light mb-8" dangerouslySetInnerHTML={{ __html: data.unit.paragraph_3 }}></p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {data.principals.map((module, idx) => <LearningUnit {...module} index={idx} key={idx} />)}
        </div>
